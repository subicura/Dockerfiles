...
export CATALINA_OPTS="-Djava.security.egd=file:/dev/./urandom -Dfile.encoding=UTF-8 -Xms1024m -Xmx2048m -XX:MaxPermSize=512m -XX:MaxPermSize=1024m -Djava.awt.headless=true -Dorg.apache.commons.jelly.tags.fmt.timeZone=TZ -Duser.timezone=Asia/Shanghai"
